...
if("TRUE" STREQUAL "TRUE")
  set(dialogflow_ros_SOURCE_PREFIX /home/jetson/nourrobot_ws/src/dialogflow_ros)
  set(dialogflow_ros_DEVEL_PREFIX /home/jetson/nourrobot_ws/devel/.private/dialogflow_ros)
  ...
  set(dialogflow_ros_INSTALL_PREFIX /home/jetson/nourrobot_ws/install)
...
if(NOT "/home/jetson/nourrobot_ws/devel/.private/dialogflow_ros/include " STREQUAL " ")
  set(dialogflow_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/jetson/nourrobot_ws/devel/.private/dialogflow_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dialogflow_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/nourrobot_ws/src/dialogflow_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT dialogflow_ros_NUM_DUMMY_TARGETS)
      set(dialogflow_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::dialogflow_ros::wrapped-linker-option${dialogflow_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR dialogflow_ros_NUM_DUMMY_TARGETS "${dialogflow_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::dialogflow_ros::wrapped-linker-option${dialogflow_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND dialogflow_ros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jetson/nourrobot_ws/devel/.private/dialogflow_ros/lib;/home/jetson/nourrobot_ws/devel/lib;/opt/ros/melodic/lib)
