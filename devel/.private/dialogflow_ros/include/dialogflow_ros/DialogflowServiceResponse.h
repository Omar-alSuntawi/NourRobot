...
bool operator==(const ::dialogflow_ros::DialogflowServiceResponse_<ContainerAllocator1> & lhs, const ::dialogflow_ros::DialogflowServiceResponse_<ContainerAllocator2> & rhs)
{
